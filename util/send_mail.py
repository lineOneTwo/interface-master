...
class SendEmail:
    ...
    global email_host
    global password
    password = "yraqrrrduatxbeii"
    email_host = "smtp.qq.com"
    send_user = "903369232@qq.com"

    def send_mail(self, user_list, sub, content):
        user = "interfaceTest" + "<" + send_user + ">"
        ...
        # 发送邮件
        try:
            server = smtplib.SMTP_SSL(email_host, 465)  # 启用SSL发信, 端口一般是465
